...
Os estados sob Regime de Recuperação Fiscal ou suspensão judicial de pagamentos --- Rio de Janeiro e Rio Grande do Sul desde 2017 e Goiás desde 2022 --- concentram os episódios de maior deterioração fiscal do período e operaram, nesses anos, sob regime institucional distinto do teto contratual de 1997. Para verificar se o resultado principal é sensível a esses casos extremos, a especificação I-B foi reestimada excluindo os respectivos estados-anos (Tabela~\ref{tab:resultados}, coluna I-D; $N = 484$). Os coeficientes preservam sinal, significância e magnitude ($\hat{\beta}_1 = 0{,}696$; $\hat{\beta}_2 = -0{,}044$; ambos $p < 0{,}01$), indicando que a relação estimada entre desenho contratual e reação fiscal não é artefato dos estados em crise fiscal aguda. 

A tripla interação $d_{i,t-1} \times teto_i \times binding_{i,t-1}$ investiga se o efeito moderador do teto é mais forte quando o estado já operava próximo do limite. O coeficiente mostrou-se marginalmente significativo ($\hat{\beta}_3 = 0{,}0021$; $p = 0{,}09$), com sinal positivo, enquanto $\hat{\beta}_1$ e $\hat{\beta}_2$ permanecem estáveis ($\hat{\beta}_1 = 0{,}592$; $\hat{\beta}_2 = -0{,}038$). O sinal positivo aponta na direção oposta à hipótese: estados operando próximos ao limite ajustam, se algo, marginalmente mais --- e não menos ---, de modo que a proximidade da restrição não reforça o papel moderador do teto. Como o coeficiente é identificado a partir de apenas 18 das 500 observações e é fortemente colinear com o termo $d_{i,t-1} \times teto_i$, sua estimativa é imprecisa e não sustenta interpretação robusta. O papel moderador do teto permanece, portanto, associado ao seu desenho contratual em si, e não à proximidade de violação do limite.

Cabe ressalvar, porém, que apenas 18 das 500 observações da amostra apresentam \textit{binding}$_{i,t-1}$ igual a 1, distribuídas por dez unidades federativas --- com maior frequência em RJ e MG --- e concentradas nos anos de 2020 a 2023, além de ocorrências isoladas em 2007.\footnote{A concentração recente reflete o estresse fiscal associado à pandemia de COVID-19 e seus desdobramentos orçamentários. Estados sob suspensão de pagamentos tendem a não ser classificados como $binding$ justamente nos anos de suspensão, dado que a razão encargos/RCL cai nesses períodos.} Assim, o teste dispõe de pouca capacidade estatística para detectar diferenças entre grupos, ainda que elas existam.
